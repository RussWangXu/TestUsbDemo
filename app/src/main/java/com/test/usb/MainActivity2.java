...
//                    writeButton.setEnabled(false);
        ...
        configButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View arg0) {
                Toast.makeText(MainActivity2.this, "点击config", Toast.LENGTH_SHORT).show();
        ...
        writeButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View arg0) {
                Toast.makeText(MainActivity2.this, "点击写入的按钮", Toast.LENGTH_SHORT).show();
...
//                readText.append((String) msg.obj);
    ...
    private void initUI() {
        ...
        clearButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View arg0) {
                Toast.makeText(MainActivity2.this, "清空文字", Toast.LENGTH_SHORT).show();
                readText.setText("");
            }
        });
        return;
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (length > 0) {
                    ...
                    String recv2 = new String(buffer, 0, length);        //以字符串形式输出
                    msg.obj = recv;
